...
export class Tab3Page
  ...
  private ciclosComunicacion =
    0;

  private readonly sectorIds:
  ...
  get estadoHumedadSuelo():
    string {

    if (
      this.dashboard.humedadSuelo <
      30
    ) {
      return 'Humedad baja';
    }
  ...
  private simularEstadoComunicacion():
    void {
  ...
  private simularTodosLosDatos():
    void {

    this.simularDatosSector(
      this.dashboardSector1
    );
  ...
  private simularDatosSector(
    datos: DashboardData
  ): void {

    datos.humedadAmbiente =
      this.limitarRedondear(
        datos.humedadAmbiente +
          this.variacion(2),
        25,
        85
  ...
  private actualizarAlertas():
    ...
    if (!this.esp32Conectado) {
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          'No se están recibiendo datos del dispositivo.',
    ...
    if (
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          `La batería se encuentra al ${this.dashboard.bateria}%.`,
    ...
    if (
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          `${this.nombreSectorSeleccionado} necesita riego.`,
    ...
    if (this.dashboard.lluvia) {
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          'El riego debe mantenerse detenido.',
    ...
    if (
      this.dashboard.temperaturaCaja >=
      38
    ) {

      nuevasAlertas.push({
        titulo:
          'Temperatura elevada en la caja',

        descripcion:
          'Revise la ventilación de la caja electrónica.',
    ...
    if (
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          'No se detectaron errores ni alertas.',
      ...
      nuevasAlertas.push({
        ...
        descripcion:
          'Los datos del ESP32 se reciben correctamente.',
  ...
  getHistorialRiego(): void {
    ...
    this.http
      .get<any>(
        'https://apiriego.onrender.com/historial'
      )
      .subscribe({
  ...
  private drawChart(): void {
    ...
    const filas =
      this.obtenerFilasGrafica();

    datosGrafica.addRows(
      filas
    );
